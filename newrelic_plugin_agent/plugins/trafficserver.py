...
'''
-- CACHE INFORMATION
x Disk Used    1.7G   proxy.process.cache.bytes_used
x Disk Total   2.1G   proxy.process.cache.bytes_total

x Ram Used    19.8M   proxy.process.cache.ram_cache.bytes_used
x Ram Total   21.0M   proxy.process.cache.ram_cache.total_bytes
Ram Hit     33.5%   proxy.process.cache.ram_cache.hits / proxy.process.cache.ram_cache.hits + proxy.process.cache.ram_cache.misses

Lookups     27.8    proxy.process.http.cache_lookups
Writes       5.0    proxy.process.http.cache_writes
Updates      4.0    proxy.process.http.cache_updates
Deletes      0.0    proxy.process.http.cache_deletes

Read Activ   1.0    proxy.process.cache.read.active
Writes Act   1.0    proxy.process.cache.write.active
Update Act   1.0    proxy.process.cache.update.active

x Entries    175.4K   proxy.process.cache.direntries.used
x Avg Size     9.8K   "disk_used" / "entries"

x Fresh       64.9%   proxy.process.http.transaction_counts.hit_fresh
x Revalidate   0.0%   proxy.process.http.transaction_counts.hit_revalidated
x Cold        19.0%   proxy.process.http.transaction_counts.miss_cold
x Changed     14.3%   proxy.process.http.transaction_counts.miss_changed
x Not Cache    0.0%   proxy.process.http.transaction_counts.miss_not_cacheable

x No Cache     0.0%   proxy.process.http.transaction_counts.miss_client_no_cache

x Fresh (ms) 125.2K   proxy.process.http.transaction_totaltime.hit_fresh
x Reval (ms)   0.0    proxy.process.http.transaction_totaltime.hit_revalidated
x Cold (ms)  255.1K   proxy.process.http.transaction_totaltime.miss_cold
x Chang (ms) 212.0K   proxy.process.http.transaction_totaltime.miss_changed
x Not (ms)     0.0    proxy.process.http.transaction_totaltime.miss_not_cacheable
x No (ms)      0.0    proxy.process.http.transaction_totaltime.miss_client_no_cache

x DNS Entry    5.8K   proxy.process.hostdb.cache.current_items
x DNS Hit    100.0%   "dns_hits" / "dns_lookups"
x DNS Lookup   9.6    proxy.process.hostdb.total_lookups
x DNS Hits     9.6    proxy.process.hostdb.total_hits
...
100 B        0.0%   proxy.process.http.response_document_size_100
1 KB        89.9%   proxy.process.http.response_document_size_1K
3 KB         8.9%   proxy.process.http.response_document_size_3K
5 KB         0.0%   proxy.process.http.response_document_size_5K
10 KB        0.0%   proxy.process.http.response_document_size_10K
1 MB         0.0%   proxy.process.http.response_document_size_1M
> 1 MB       0.0%   proxy.process.http.response_document_size_inf

-- CLIENT
x Requests    27.9  proxy.process.http.incoming_requests
x New Conn     0.5  proxy.process.http.total_client_connections
x Req/Conn    56.0  "client_req" / "client_conn"
x Curr Conn   19.0    proxy.process.http.current_client_connections
x Active Con   2.0    proxy.process.http.current_active_client_connections
x Head Bytes  12.3K   proxy.process.http.user_agent_response_header_total_size
x Body Bytes  15.3K   proxy.process.http.user_agent_response_document_total_size
x Avg Size   988.1    "client_head" + "client_body" / client_req
x Net (bits) 220.9K   "client_head" + "client_body"
Resp (ms)    4.4    proxy.process.http.total_transactions_time / "client_req"

(KA Total)    proxy.process.net.dynamic_keep_alive_timeout_in_total
(KA Count)   proxy.process.net.dynamic_keep_alive_timeout_in_count
Dynamic KA   0.0    "ka_total" / "ka_count"


(client_abort)   proxy.process.http.err_client_abort_count_stat
(conn_fail)  proxy.process.http.err_connect_fail_count_stat
(abort)  proxy.process.http.transaction_counts.errors.aborts
(t_conn_fail)   proxy.process.http.transaction_counts.errors.connect_failed
(other_err) proxy.process.http.transaction_counts.errors.other

-- ORIGIN SERVER
x Requests     9.8  proxy.process.http.outgoing_requests
x Curr Conn    4.0    proxy.process.http.current_server_connections
x Req/Conn    14.7  "server_req", "server_conn"
x New Conn     0.7    proxy.process.http.total_server_connections
x Head Bytes   3.1K   proxy.process.http.origin_server_response_header_total_size
x Body Bytes   6.6K   proxy.process.http.origin_server_response_document_total_size
x Avg Size   993.1    server_size + server_req / server_req
x Net (bits)  78.0K   server_size + server_req
'''
...
class ATS(base.JSONStatsPlugin):
    ...
    def add_connection_datapoints(self, stats):
        ...
        for key, label in ATS.CONNECTIONS_GAUGES.items():
